                    ...
                    <div className="row justify-content-between align-items-center">
                        ...
                        <div className="col-lg-7">
                            ...
                            <div className="mil-hero-text">
                                ...
                                <h1 className="mil-h2 mil-mb-30">UNSC</h1>
                                {/* <p className="mil-mb-30" dangerouslySetInnerHTML={{__html : Data.description}} /> */}
                                <h1 className="mil-h4 mil-mb-30">United Nations Security Counsil</h1>
                                <p className="mil-mb-30"> Strengthening International Cooperation in Cybersecurity.</p>
                                ...
                                <Link href={Data.button2.link} className="mil-link-hover">Register</Link>
                                 {/* buttons end */}
