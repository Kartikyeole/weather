                ...
                <Link href="/" legacyBehavior>
                  <a className="mil-logo mil-scale-down-trigger mil-accent-trigger">
                      <div className="mil-h5">
                        <span> <img src={invert ? appData.header.logo.url3 : appData.header.logo.url} style={{width: "25%"}} /> </span> <span> <img src={invert ? appData.header.logo.url4 : appData.header.logo.url2} style={{width: "26%"}} /> </span> <span className="mil-accent">{appData.header.logo.accent}</span>
                      </div>
                  </a>
                </Link>
